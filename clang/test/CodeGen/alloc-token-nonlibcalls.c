// RUN: %clang_cc1    -fsanitize=alloc-token -fsanitize-alloc-token-extended -fsanitize-alloc-token-max=2147483647 -triple x86_64-linux-gnu -x c -emit-llvm %s -o - | FileCheck %s
// RUN: %clang_cc1 -O -fsanitize=alloc-token -fsanitize-alloc-token-extended -fsanitize-alloc-token-max=2147483647 -triple x86_64-linux-gnu -x c -emit-llvm %s -o - | FileCheck %s
