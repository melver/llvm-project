...
ContainsPtr *test_malloc_struct_with_ptr() {
  ...
  // CHECK: call{{.*}} ptr @__alloc_partition_malloc(i64 noundef 16, i64 0)
...
ContainsPtr *test_malloc_struct_array_with_ptr() {
  // FIXME: This should not be partition ID 0!
  // CHECK: call{{.*}} ptr @__alloc_partition_malloc(i64 noundef 160, i64 0)
...
ContainsPtr *test_operatornew_struct_with_ptr() {
  // FIXME: This should not be partition ID 0!
  // CHECK: call {{.*}} ptr @__alloc_partition_Znwm(i64 noundef 16, i64 0)
...
ContainsPtr *test_operatornew_struct_array_with_ptr() {
  // FIXME: This should not be partition ID 0!
  // CHECK: call {{.*}} ptr @__alloc_partition_Znwm(i64 noundef 160, i64 0)
