...
Querying Token IDs with ``__builtin_alloc_token_id``
====================================================
...
.. code-block:: c
    ...
    uint64_t __builtin_alloc_token_id(<args>, ...);
...
.. code-block:: c
    ...
    #define partition_alloc(...) __partition_alloc(__VA_ARGS__, __builtin_alloc_token_id(__VA_ARGS__))
...
AllocToken instrumentation is enabled. The
