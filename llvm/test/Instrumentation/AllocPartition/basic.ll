...
entry:
  ; CHECK: [[PTR1:%[0-9]]] = call ptr @__alloc_partition_malloc(i64 64, i64 0)
  ; CHECK: call ptr @__alloc_partition_calloc(i64 8, i64 8, i64 1)
  ; CHECK: call ptr @__alloc_partition_realloc(ptr [[PTR1]], i64 128, i64 2)
...
entry:
  ; CHECK: call ptr @__alloc_partition_Znwm(i64 32, i64 3)
  ; CHECK: call ptr @__alloc_partition_Znam(i64 64, i64 4)
...
define void @test_free_untouched(ptr %ptr) sanitize_alloc_partition {
entry:
  ; CHECK: call void @free(ptr %ptr)
  ; CHECK: call void @_ZdlPv(ptr %ptr)
  ; CHECK-NOT: call ptr @__alloc_partition_
...
define i32 @no_allocations(i32 %x) sanitize_alloc_partition {
entry:
  ; CHECK: call i32 @foobar
  ; CHECK-NOT: call i32 @__alloc_partition_
...
define ptr @test_tail_call_preserved() sanitize_alloc_partition {
entry:
  ; CHECK: tail call ptr @__alloc_partition_malloc(i64 42, i64 5)
