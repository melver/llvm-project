...
declare void @f.sanitize_alloc_partition() sanitize_alloc_partition
; CHECK: declare void @f.sanitize_alloc_partition() #54
...
; CHECK: attributes #54 = { sanitize_alloc_partition }
