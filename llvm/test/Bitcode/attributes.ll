...
; CHECK: define void @f_sanitize_alloc_partition() #55
define void @f_sanitize_alloc_partition() sanitize_alloc_partition {
        ret void;
}
...
; CHECK: attributes #55 = { sanitize_alloc_partition }
